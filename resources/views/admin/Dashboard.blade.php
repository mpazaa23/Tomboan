...
<body class="bg-gray-100 font-sans flex h-screen overflow-hidden">
                    ...
                    <table class="w-full text-left text-sm text-gray-600">
                        ...
                        <tbody class="divide-y divide-gray-400">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4 font-medium text-gray-900">{{ $res->nama }}</td> <td class="px-6 py-4">{{ $res->tanggal_reservasi }}</td>
    ...
    <table class="w-full text-left text-sm text-gray-600">
        <thead class="bg-gray-50 text-gray-800 uppercase font-bold">
            <tr>
                <th class="px-6 py-3">Nama</th>
                <th class="px-6 py-3">Status</th> <th class="px-6 py-3 w-1/3">Isi Cerita</th>
                <th class="px-6 py-3">Aksi</th>
            </tr>
        </thead>
...
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
   ...
   <script>
    ...
    function openEditReservasi(button) {
        ...
        // 2. Isi formulir modal dengan data tersebut
        ...
        // 3. Atur URL Form agar mengarah ke rute update yang benar
        // Pastikan URL-nya sesuai dengan route di web.php kamu (misal: /reservasi/{id})
        const form = document.getElementById('formEditReservasi');
        // Ganti '/reservasi/' dengan prefix route kamu jika berbeda (misal: /admin/reservasi/)
